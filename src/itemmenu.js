	...
	constructor(props) {
		...
		this.state = {
			...
			GridViewItems: [
				{
				key: ' ITEM\n READY',
				MenuIcon_url:item_ready
				},
				{
				key: '  ITEM\n READY/QTY',
				MenuIcon_url:item_ready_qty
				},

				{
				key: ' ITEM\n BROKEN',
				MenuIcon_url:item_broken
				},
				{
				key: ' ITEM\n RELOAD',
				MenuIcon_url:item_reload
				},
				],
		};
					...
					renderItem={({item}) =>{
						return (
							<View style={styles.GridViewBlockStyle}>
								<TouchableOpacity style={{height:600, width:400,alignItems: 'center', justifyContent: 'center',}}onPress={this.Gotomenu.bind(this, item.key)}>
									<Text style={styles.GridViewInsideTextItemStyle}  onPress={this.Gotomenu.bind(this,item.key)} > {item.key}  </Text>
									<Image
									source={item.MenuIcon_url}
